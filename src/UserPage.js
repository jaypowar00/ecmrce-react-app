...
import UserClassComponent from './components/User'
...
class UserPage extends PureComponent {
    constructor(props) {
        super(props)
        this.state = {
            show1: (this.props.loggedIn)?false:true,
            show2: false
        }
        this.errorMsg = "";
    ...
    render(){
        return (
            <>
                ...
                <Navbar username={this.props.username} loggedIn={this.props.loggedIn} handleClose={this.handleClose} handleClose2={this.handleClose2} handleShow={this.handleShow} handleShow2={this.handleShow2} getCookie={this.props.getCookie}/>
                <UserClassComponent username={this.props.username} loggedIn={this.props.loggedIn} user={this.props.user} checkLoginStatus={this.props.checkLoginStatus} handleClose={this.handleClose} handleClose2={this.handleClose2} handleShow={this.handleShow} handleShow2={this.handleShow2} getCookie={this.props.getCookie}/>
            </>
        )
    }   
}
